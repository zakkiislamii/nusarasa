  ...
  return (
    <div className="relative flex-1 p-6 flex justify-center items-center">
      <div className="w-full max-w-[35rem] p-1 text-[#554433] flex flex-col border border-black gap-[15px] relative text-center items-center justify-center z-10 rounded-xl bg-[#F9F5F0]">
        <div className="p-5 pt-10 font-bold text-4xl w-full"></div>
        <form
            ...
            <div className="flex flex-col gap-3 sm:gap-4 text-start w-full md:w-[calc(50%-10px)]">
              ...
              <div className="relative flex justify-center items-center text-[#1E1E1E]">
                ...
                <input
                  ...
                  className="w-full h-auto sm:h-[40px] py-2 placeholder-custom-gray pl-12 pr-5 border border-[#F9F5F0] text-[#1E1E1E] rounded-md text-left"
                />
              </div>
            </div>
